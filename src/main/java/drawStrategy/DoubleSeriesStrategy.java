...
public class DoubleSeriesStrategy implements DrawStrategy{
	...
	public JComponent lineChart(JPanel charts, Analysis a) {
		...
		System.out.println(a.getGraphName());
		...
		JFreeChart chart = ChartFactory.createXYLineChart(a.getCountry() + " " +a.getGraphName(), "Year", "", dataset,
...
//		plot.setDataset(1, dataset2);
	...
	public JComponent pieChart(JPanel charts, Analysis a) {
		...
		JFreeChart pieChart = ChartFactory.createMultiplePieChart(a.getCountry() + " " + a.getGraphName(), dataset,
	...
	public JComponent report(JPanel charts, Analysis a) {
		...
		reportMessage = a.getCountry() + " " + a.getGraphName() + "\n==============================\n";
		for (int i = 0; i < a.toYear+1-a.fromYear; i++) {
